...
function createWindow() {
    ...
    if (serve) {
        ...
        win.loadURL(url.format({
            pathname: path.join(__dirname, 'dist/PowerboardFW_new/index.html'),
            protocol: 'file',
            slashes: true,
        }));
    }
    ...
    win.webContents.on('new-window', function (event, winURL, frameName, disposition, options, additionalFeatures) {
        if (frameName === 'modal') {
