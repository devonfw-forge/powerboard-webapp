...
import { ConfigureImagesComponent } from './configure-images.component';

describe('ConfigureImagesComponent', () => {
  let component: ConfigureImagesComponent;
  let fixture: ComponentFixture<ConfigureImagesComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ConfigureImagesComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ConfigureImagesComponent);
  ...
  it('delete image should give error for null data', () => {
    component.deleteImage(null).catch((e) => {
      expect(e).toEqual('Cannot DELETE /v1/images/delete/');
    });
  });

  /* it('dropped image should give error for null data', () =>{
    component.dropped(null).catch((e)=>{
      expect(e).toEqual('Cannot POST /v1/images/uploadImage/');
    })
  }); */

  it('component ready should', () => {
    component.updateComponent();
    expect(component.componentReady).toEqual(true);
  });
});
