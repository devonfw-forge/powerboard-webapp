...
describe('AuthService', () => {
  ...
  it('should return data', async() => {
    ...
    const req = httpTestingController.expectOne(
      {
      method: "POST",
      url :   'http://localhost:3000/bapi/v1/auth/login'
      });
    req.flush([response]);
  ...
  it('login should throw erorr for null data', () =>{
    ...
    let req = httpTestingController.expectOne("http://localhost:3000/bapi/v1/auth/login");
  ...
  it('reset password should throw error', async() =>{
    ...
    service.resetPassword(resetpasswordForm).then((data) =>{
      ...
      let req = httpTestingController.expectOne("http://localhost:3000/bapi/v1/auth/change-password");
  ...
  it('guest login should return data', async() => {
    ...
    const req = httpTestingController.expectOne(
      {
      method: "POST",
      url :   'http://localhost:3000/bapi/v1/auth/login/guest'
      });
    req.flush([response]);
