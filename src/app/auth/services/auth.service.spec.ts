...
describe('AuthService', () => {
  ...
  it('should return data', async () => {
    ...
    const req = httpTestingController.expectOne({
      method: 'POST',
      url: environment.restPathRoot + 'v1/auth/login',
    });
    req.flush([response]);
  ...
  it('login should throw erorr for null data', () => {
    ...
    let req = httpTestingController.expectOne(
      environment.restPathRoot + 'v1/auth/login'
    );
  ...
  it('reset password should throw error', async () => {
    ...
    let req = httpTestingController.expectOne(
      environment.restPathRoot + 'v1/auth/change-password'
    );
